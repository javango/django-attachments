...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.display_name'
        db.add_column('attachments_attachment', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.display_name'
        db.delete_column('attachments_attachment', 'display_name')
